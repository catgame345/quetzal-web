defmodule PeriodisticWeb.PostLiveTest do
  use PeriodisticWeb.ConnCase

  import Phoenix.LiveViewTest
  import Periodistic.DataFixtures

  @create_attrs %{autor: "some autor", email: "some email", texto: "some texto", imagenes: "some imagenes", enlaces: "some enlaces", riesgo: true}
  ...
  @invalid_attrs %{autor: nil, email: nil, texto: nil, imagenes: nil, enlaces: nil, riesgo: false}
  ...
  describe "Index" do
    ...
    test "updates post in listing", %{conn: conn, post: post} do
      ...
      assert html =~ "some updated autor"
    end
